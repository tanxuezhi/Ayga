...
RcppExport SEXP _ARyga_cpp_pairwise_distances_XYstr(SEXP XSEXP, SEXP YSEXP, SEXP str_metricSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _ARyga_cpp_pairwise_distances_Xstr(SEXP XSEXP, SEXP str_metricSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type X(XSEXP);
...
RcppExport SEXP _ARyga_cpp_pairwise_distances_XYCall(SEXP XSEXP, SEXP YSEXP, SEXP metricSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type X(XSEXP);
...
RcppExport SEXP _ARyga_cpp_pairwise_distances_XCall(SEXP XSEXP, SEXP metricSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type X(XSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_ARyga_cpp_pairwise_distances_XYstr", (DL_FUNC) &_ARyga_cpp_pairwise_distances_XYstr, 3},
    {"_ARyga_cpp_pairwise_distances_Xstr", (DL_FUNC) &_ARyga_cpp_pairwise_distances_Xstr, 2},
    {"_ARyga_cpp_pairwise_distances_XYCall", (DL_FUNC) &_ARyga_cpp_pairwise_distances_XYCall, 3},
    {"_ARyga_cpp_pairwise_distances_XCall", (DL_FUNC) &_ARyga_cpp_pairwise_distances_XCall, 2},
    {"_rcpp_module_boot_yada", (DL_FUNC) &_rcpp_module_boot_yada, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_ARyga(DllInfo *dll) {
