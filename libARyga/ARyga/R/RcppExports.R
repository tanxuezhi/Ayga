...
cpp_pairwise_distances_XYstr <- function(X, Y, str_metric) {
    .Call('_ARyga_cpp_pairwise_distances_XYstr', PACKAGE = 'ARyga', X, Y, str_metric)
}
...
cpp_pairwise_distances_Xstr <- function(X, str_metric) {
    .Call('_ARyga_cpp_pairwise_distances_Xstr', PACKAGE = 'ARyga', X, str_metric)
}
...
cpp_pairwise_distances_XYCall <- function(X, Y, metric) {
    .Call('_ARyga_cpp_pairwise_distances_XYCall', PACKAGE = 'ARyga', X, Y, metric)
}
...
cpp_pairwise_distances_XCall <- function(X, metric) {
    .Call('_ARyga_cpp_pairwise_distances_XCall', PACKAGE = 'ARyga', X, metric)
}
